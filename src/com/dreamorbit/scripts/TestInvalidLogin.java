...
public class TestInvalidLogin extends BaseTest {
	...
	public void testInvalidlogin() throws InterruptedException {
		...
		for (int i = 1; i <= rowCount; i++) {
			...
			AssertJUnit.assertTrue(warningMSG.equals("Incorrect username or password.")
					|| warningMSG.equals("User does not exist.")
					|| warningMSG.equals("Temporary password has expired and must be reset by an administrator."));
