...
public class AddResearcherTest extends BaseTest {
	...
	public void AddResearcherCheckValid() throws InterruptedException {
		...
		Reporter.log("Researcher is getting added successfully- Test case is passed", true);
		Thread.sleep(2000);
	...
	@Test(priority = 13, enabled = true) // issue
